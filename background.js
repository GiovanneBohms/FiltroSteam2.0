  ...
  if (
    ...
    if (nextState === "ON") {
      await chrome.scripting
        .executeScript({
          target: { tabId: tab.id },
          files: ["./src/config.js","./src/APIs.js","./src/dependencias.js","./src/db.js","./src/coletaIdNamePriceQuant.js","./src/coletaCotacoes.js","./src/telas.js","./src/book.js","./src/trading.js","./src/index.js"],
        })
